...
const resources = [
  // Crisis
  { icon: '🆘', title: '988 Suicide & Crisis Lifeline', desc: 'Free, confidential support 24/7 by call or text. Dial or text 988.', category: 'crisis', link: 'tel:988', linkText: 'Call or Text 988' },
  { icon: '💬', title: 'Crisis Text Line', desc: 'Text HOME to 741741. Free, 24/7 crisis support via SMS.', category: 'crisis', link: 'sms:741741', linkText: 'Text HOME to 741741' },
  { icon: '🌍', title: 'Find A Helpline', desc: 'International directory of crisis support lines by country and topic.', category: 'crisis', link: 'https://findahelpline.com', linkText: 'Visit Resource' },
  { icon: '🟣', title: 'IASP Crisis Centre Directory', desc: 'Crisis centres worldwide from the International Association for Suicide Prevention.', category: 'crisis', link: 'https://www.iasp.info/resources/Crisis_Centres/', linkText: 'Visit Resource' },
  // Apps
  { icon: '🤖', title: 'Woebot', desc: 'An AI-powered companion using CBT techniques to help with anxiety and low mood.', category: 'apps', link: 'https://woebothealth.com', linkText: 'Visit Resource' },
  { icon: '🧘', title: 'Headspace', desc: 'Guided meditations, sleep sounds, and mindfulness exercises for daily wellbeing.', category: 'apps', link: 'https://www.headspace.com', linkText: 'Visit Resource' },
  { icon: '🌿', title: 'Calm', desc: 'Sleep stories, breathing exercises, and relaxation tools for stress and anxiety.', category: 'apps', link: 'https://www.calm.com', linkText: 'Visit Resource' },
  { icon: '🦋', title: 'Wysa', desc: 'AI-powered emotional support and CBT exercises, with optional access to human coaches.', category: 'apps', link: 'https://www.wysa.io', linkText: 'Visit Resource' },
  // Screening
  { icon: '📋', title: 'PHQ-9 Depression Screen', desc: 'A validated 9-question tool used by clinicians to assess depression severity.', category: 'screening', link: 'https://www.phqscreeners.com', linkText: 'Visit Resource' },
  { icon: '📊', title: 'GAD-7 Anxiety Screen', desc: 'A 7-item validated scale for generalized anxiety often used in primary care.', category: 'screening', link: 'https://www.phqscreeners.com', linkText: 'Visit Resource' },
  { icon: '🧪', title: 'NAMI Mental Health Screening', desc: 'Free, anonymous online screening tools from the National Alliance on Mental Illness.', category: 'screening', link: 'https://www.nami.org/Support-Education/NAMI-HelpLine/Top-FAQs/How-to-Find-a-Mental-Health-Screener', linkText: 'Visit Resource' },
  // Community
  { icon: '🫂', title: '7 Cups', desc: 'Free, anonymous peer support and professional online therapy for any concern.', category: 'community', link: 'https://www.7cups.com', linkText: 'Visit Resource' },
  { icon: '🤝', title: 'NAMI Peer Groups', desc: 'Free in-person and online peer support groups led by trained people with lived experience.', category: 'community', link: 'https://www.nami.org/Support-Education/Support-Groups', linkText: 'Visit Resource' },
  { icon: '💚', title: 'Mental Health America', desc: 'Community tools, advocacy resources, and a national network of local affiliates.', category: 'community', link: 'https://www.mhanational.org', linkText: 'Visit Resource' },
  // Professionals
  { icon: '🩺', title: 'Physician Support Line', desc: 'Confidential, free peer support for physicians and medical students. Call 1-888-409-0141.', category: 'professionals', link: 'https://www.physiciansupportline.com', linkText: 'Visit Resource' },
  { icon: '📄', title: 'Therapist Aid Worksheets', desc: 'Free, professionally reviewed worksheets and CBT tools for clients and practitioners.', category: 'professionals', link: 'https://www.therapistaid.com', linkText: 'Visit Resource' },
  { icon: '🏛️', title: 'APA Practice Resources', desc: 'American Psychological Association\'s library of clinical practice guidelines and tools.', category: 'professionals', link: 'https://www.apa.org/practice', linkText: 'Visit Resource' },
];
...
function displayResults(band, summary) {
  ...
  if (labelEl) {
    labelEl.innerHTML = `ℹ️ <strong>Informational pattern:</strong> ${BAND_LABELS[band]}`;
  }
